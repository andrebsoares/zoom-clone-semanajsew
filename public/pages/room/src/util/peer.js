class PeerBuilder {
    ...
    //Adicionar o comportamento dis eventos de call também para quem ligar
    _preparePeerInstanceFunction(peerModule){
        ...
        PeerCustomModule.prototype.call = function(id, stream){
            ...
            //aqui acontece a magia, interceptamos o call e adicionamos todos os eventos da chamada de quem liga também
